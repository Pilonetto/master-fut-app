 ...
 *   $ionicConfigProvider.backButton.text('Go Voltar').icon('ion-chevron-left');
 * });
 * ```
 */
 ...
 * @description Voltar button icon.
 * @param {string} value
 * @returns {string}
 */
 ...
 * @description Voltar button text.
 * @param {string} value Defaults to `Voltar`.
 * @returns {string}
 */
